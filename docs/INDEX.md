...
| 日期 | 标题 | 标签 | 文件 |
|------|------|------|------|
| 2026-06-09 | 2026 618 AI 电商：意图购物、平台格局与答案时代 | `ai-ecommerce`, `618`, `intent-commerce`, `qianwen`, `doubao`, `geo`, `market-trend` | [笔记](../notes/ai-tools/geo/2026-06-09-618-ai-ecommerce-platform-landscape.md) · `KB-AI-20260609-618-ai-ecommerce-platform-landscape` |
...
| 日期 | 标题 | 标签 | 文件 |
|------|------|------|------|
| 2026-08-04 | Akamai sensor_data 全参数拆解与工程实现 | `akamai`, `sensor-data`, `anti-crawler`, `device-fingerprint`, `js-reverse`, `ast`, `browser-emulation`, `hook`, `mouse-fingerprint`, `jsvmp`, `ai-assisted`, `real-case` | [笔记](../notes/crawler/2026-08-04-akamai-sensor-data-engineering.md) · `KB-CR-20260804-akamai-sensor-data-engineering` |
...
| 2026-06-11 | JSVMP 概述与 JS 代码保护全景 | `js-reverse`, `jsvmp`, `vmp`, `anti-crawler`, `code-protection`, `obfuscation`, `wasm`, `security`, `jsvmp-theory` | [笔记](../notes/crawler/2026-06-11-jsvmp-overview-protection-landscape.md) · `KB-CR-20260611-jsvmp-overview-protection-landscape` |
| 2026-06-11 | JSVMP 虚拟化流水线：AST 拆分→字节码编码 | `js-reverse`, `jsvmp`, `vmp`, `anti-crawler`, `ast`, `bytecode`, `instruction-encoding`, `intermediate-code`, `obfuscation`, `jsvmp-theory` | [笔记](../notes/crawler/2026-06-11-jsvmp-virtualization-pipeline.md) · `KB-CR-20260611-jsvmp-virtualization-pipeline` |
...
新增标签：`akamai` · `sensor-data` · `mouse-fingerprint` · `sha1` · `aes-gcm` · `response-decode`
...
| 日期 | 操作 | 笔记 |
|------|------|------|
| 2026-08-04 | 新建 | [Akamai sensor_data 全参数拆解与工程实现](../notes/crawler/2026-08-04-akamai-sensor-data-engineering.md)（ING-20260804-001） |
...
| 2026-06-11 | 新建 | [瑞数vmp动态代码生成原理逆向分析](../notes/crawler/2026-06-11-rs-vmp-dynamic-code-generation.md)（ING-20260611-001） |
