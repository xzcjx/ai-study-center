...
difficulty: beginner
status: active
related: [KB-AI-20260608-taste-skill-agent-frontend, KB-AI-20260608-awesome-ai-tools-for-ui, KB-AI-20260608-three-ways-remove-ai-slop, KB-AI-20260608-awesome-design-md-agent-ui]
...
- 项目内：[awesome-design-md DESIGN.md](2026-06-08-awesome-design-md-agent-ui.md)（`KB-AI-20260608-awesome-design-md-agent-ui`，Skill + DESIGN.md 组合）
